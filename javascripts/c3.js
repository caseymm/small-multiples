(function (window) {
    ...
    function Chart(config, idx) {
        var $$ = this.internal = new ChartInternal(this, idx);
        $$.loadConfig(config);
        $$.init();
    ...
    function ChartInternal(api, idx) {
        var $$ = this;
        $$.d3 = window.d3 ? window.d3 : typeof require !== 'undefined' ? require("d3") : undefined;
        $$.api = api;
        $$.config = $$.getDefaultConfig(idx);
        $$.data = {};
        $$.cache = {};
        $$.axes = {};
    }

    c3.generate = function (config, idx) {
        return new Chart(config, idx);
    };
    ...
    c3_chart_internal_fn.initWithData = function (data) {
        ...
        $$.y2.domain($$.getYDomain($$.data.targets, 'y'));
    ...
    c3_chart_internal_fn.getDefaultConfig = function (idx) {
        var config = {
            bindto: '#chart-'+idx,
    ...
    c3_chart_internal_fn.tooltipPosition = function (dataToShow, tWidth, tHeight, element) {
      ...
      // Determine tooltip position
        if (forArc) {
          ...
          // Commented out vars are those that position the tooltip to stick to the line for the group
            svgLeft = $$.getSvgLeft(true);
            tooltipLeft = mouse[0]+$$.margin.left;
            tooltipTop = mouse[1] + 25;
            if (config.axis_rotated) {
    ...
    c3_chart_internal_fn.getTargetSelectorSuffix = function (targetId) {
        return targetId || targetId === 0 ? ('-' + targetId).replace(/[()]/g, '').replace(/[\s?!@#$%^&*()_=+,.<>'":;\[\]\/|~`{}\\]/g, '-') : '';
    };
